			 ...
			 <div class="card">
				...
				<div class="card-body--">
				   ...
				   <table class="table">
                        ...
                        <tbody>
                            <?php 
                                $res = mysqli_query($con,"select order_master.*,order_status.name as order_status_str 
								from order_master,order_status where order_status.id = order_master.order_status");
