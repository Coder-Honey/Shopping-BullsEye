		  ...
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   ...
				   <h4 class="box-link"><a href="manage_sub_category.php">Add Categories</a> </h4>
				</div>
				<div class="card-body--">
						 ...
						 <tbody>
							...
							<tr>
							   ...
							   <td>
								...
								echo "<span class='badge badge-edit'><a href='manage_sub_category.php?id=".$row['id']."'>Edit</a></span>&nbsp;";
