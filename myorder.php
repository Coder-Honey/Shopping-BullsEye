                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $res = mysqli_query($con,"select order_master.*,order_status.name as order_status_str from order_master,order_status where order_master.user_id='$uid' and order_status.id = order_master.order_status");
                                                //$res = mysqli_query($con,"select * from order_master where user_id='$uid'");
                                                while($row = mysqli_fetch_assoc($res)){
                                            ?>
                                            <tr>
                                                <td class="product-add-to-cart"><a href="myorder_detail.php?id=<?php echo $row['id']?>"><?php echo $row['id']?></a>
                                                <br/>
												<a href="order_pdf.php?id=<?php echo $row['id']?>"> PDF</a>
                                                </td>
                                                <td class="product-name"><?php echo $row['added_on']?></td>
                                                <td class="product-name">
                                                    <?php echo $row['house_no']?><br/>
