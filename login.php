							...
							<div class="col-xs-12">
								<form id="login-form" method="post">
									...
									<div class="contact-btn">
										<button type="button" class="fv-btn" onclick="user_login()">Login</button><br><br>
										<p>Have you forget your password? <a href="forget_password.php" style="color:blue;">Forget Password</a></p>
									</div>
								</form>
