...
$html='<div class="wishlist-table table-responsive">
   <table>
      ...
      <tbody>';
		...
		$res=mysqli_query($con,"select distinct(order_detail.id) ,order_detail.*,product.name,product.image from order_detail,product ,order_master where order_detail.order_id='$order_id' and order_master.user_id='$uid' and order_detail.product_id=product.id");
